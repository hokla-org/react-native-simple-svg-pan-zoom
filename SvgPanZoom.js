...
class SvgPanZoom extends Component {
    ...
    render() {
        const _a = this.props, { canvasHeight, canvasWidth, viewStyle, canvasStyle, children } = _a, svgProps = __rest(_a, ["canvasHeight", "canvasWidth", "viewStyle", "canvasStyle", "children"]);
